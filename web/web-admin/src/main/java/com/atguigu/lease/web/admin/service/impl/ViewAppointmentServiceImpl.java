...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> pageviewAppointment(IPage<AppointmentVo> page, AppointmentQueryVo queryVo) {
        return viewAppointmentMapper.pageviewAppointment(page, queryVo);
    }
}
